    ...
    <>
                ...
                <li key={pkg.id}>
                  ...
                  >
                    ...
                    <div className="selected">
                      <img src="/img/white-check-icon.png" />
                    </div>
                  </div>
                </li>
              ))}
      ...
      <div className="row">
        ...
        <div className="col-sm-12 col-lg-9 col-xl-9 text-center mt-3 mt-lg-0">
          <a href="lucky-draw.html"> <img src="/img/lucky-draw-status.gif" className="rounded"/></a>
        </div>
