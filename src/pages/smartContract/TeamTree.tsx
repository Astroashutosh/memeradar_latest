...
import { getBinaryTree, packages } from "../../solana/program";
function TeamTree() {
      ...
      <div className="row">
        ...
        <div className="col-lg-4 col-xl-4 mt-0 mt-lg-3">
              ...
              <div className="col-sm-6 mt-2">
                <div className="card-body p-2 bg-gradient-violet rounded">
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="text-white  text-end"> 4000 <br/> 20</div>
                  </div>
                  <div className="d-flex justify-content-between">
                  ...
                  <div className="d-flex justify-content-between border-top">
                    ...
                    <div className="text-warning"> 4000</div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 mt-2">
                <div className="card-body p-2 bg-gradient-violet rounded">
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="text-white  text-end"> 5000 <br/> 300</div>
                  </div>
                  <div className="d-flex justify-content-between">
                    <div className="text-white">Carry Forward </div>
                  ...
                  <div className="d-flex justify-content-between border-top">
                    <div className="text-warning">Total MP </div>
                    <div className="text-warning"> 6000</div>
                  </div>
                </div>
              </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-6 mt-2">
              <div className="style-wrapper p-2 text-center">
                <img src="/img/tree-icon/golden.png" className="rounded-circle" width="50"/>
